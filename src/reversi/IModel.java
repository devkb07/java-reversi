...
{
	/* Constant meaning no player - for use when a player or piece colour is referenced */
	public static final int PLAYER_NONE = 0;

	/* Constant meaning white piece player - for use when a player or piece colour is referenced */
	public static final int PLAYER_WHITE = 1;

	/* Constant meaning black piece player - for use when a player or piece colour is referenced */
